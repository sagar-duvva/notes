...
Purpose : To Get Encrypt All Azure VM Disk on selected Sub
Output  : It will Encrypt All Azure VM Disk selected Sub
#>
#########################################################################################################################################################################
...
[String]$OutputPath=Read-Host -Prompt "Enter Output Path like D:\FolderName where DiskEncryption.csv will be created"
Write-Host "You have Selected Output Path $OutputPath"
